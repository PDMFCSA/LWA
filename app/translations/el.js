const data = {
  ...
  "scan_explain": "Βρείτε τα δεδομένα Matrix στο φάρμακό σας. Δείτε το παράδειγμα παραπάνω.",
  ...
  "onboarding_welcome": "Σχεδόν έχετε ολοκληρώσει! Παρακαλούμε διαβάστε και συμφωνήστε με τους όρους και τις προϋποθέσεις.",
  "disagree": "Διαφωνώ",
  "agree": "Συμφωνώ",
  ...
  "epi_markets_modal_title": "Επιλέξτε Χώρα",
  "epi_markets_modal_message": "Παρακαλώ επιλέξτε τη χώρα σας",
  "epi_markets_modal_no_market": "Καμία χώρα",
  ...
  "country_co": "Κολομβία",
  "country_km": "Κομπόριο",
  "country_cg": "Κονγκό, Δημοκρατία του",
  "country_cd": "Κονγκό, Η Λαϊκή Δημοκρατία του",
  "country_cr": "Κόστα Ρίκα",
  "country_ci": "Ακτή του ελεφαντόδοντου",
  "country_hr": "Κροατία",
  "country_cu": "Κούβα",
  "country_cy": "Κύπρος",
  ...
  "leaflet_print_title": "Εκτύπωση φυλλαδίου",
  "leaflet_print_description": "Οι τρέχουσες επιλεγμένες πληροφορίες θα εκτυπωθούν σε PDF.",
  "leaflet_print_description2": "Θέλετε να προχωρήσετε;",
  "leaflet_print_button": "Προχωρήστε",
  "leaflet_print_button_back": "Επιστροφή",
