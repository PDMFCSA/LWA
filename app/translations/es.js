const data = {
  ...
  "scan_explain": "Encuentre el DataMatrix en su medicamento. Ver ejemplo de arriba.",
  ...
  "system_busy": "Sistema ocupado. Por favor, vuelva a intentarlo más tarde.",
  ...
  "camera_error_message": "Algo salió mal y no se tiene acceso a la cámara seleccionada. Compruebe la configuración de su dispositivo o intente cambiar la cámara desde el menú.",
  "leaflet_lang_select_message": "El prospecto del medicamento no está disponible en su idioma. Puede elegir otro idioma disponible de la lista.",
  "lang_proceed": "Continuar",
  "go_home": "Volver al Inicio",
  "onboarding_welcome": "¡Ya casi está! Por favor, lea y acepte los términos y condiciones.",
  ...
  "epi_markets_modal_no_market": "Sin país",
  ...
  "country_zm": "Zambia",
  "country_zw": "Zimbabue",
  "leaflet_print_title": "Imprimir información",
  "leaflet_print_description": "La información seleccionada se imprimirá como PDF.",
  "leaflet_print_description2": "¿Quiere continuar?",
  ...
  "leaflet_recalled_product": "¡Product retirado!",
  "leaflet_recalled_batch": "¡Lote retirado!",
  "recalled_product_title": "Producto retirado",
  "recalled_product_message": "Este producto {0} ha sido retirado, por favor retorne el producto a su farmacia o póngase en contacto con atención al cliente - consulte en número de teléfono en el envase.",
  "recalled_product_name": "Producto: {0}",
  ...
  "document_change_lang_title": "Cambiar lenguaje",
