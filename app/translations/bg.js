const data = {
  ...
  "scan_explain": "Намерете Datamatrix-баркода на Вашето лекарство. Вижте примера по-горе.",
  ...
  "document_modal_message": "Изберете кой документ да се покаже",
  "document_patient_info": "Информация за пациенти",
  "document_product_info": "Информация за продукта",
  "document_lang_select_message": "Информацията за продукта е достъпна само на английски",
  "document_lang_select_title": "Бележка",
  "document_prescribing_info": "Кратка характеристика на продукта (за медицински специалисти)",
  "epi_markets_modal_title": "Изберете държава",
  "epi_markets_modal_message": "Изберете своята държава",
  ...
  "country_zm": "Замбия",
  "country_zw": "Зимбабве",
  "leaflet_print_title": "Печатане на информацията",
  "leaflet_print_description": "Избраната в момента информация ще бъде отпечатана като PDF.",
  "leaflet_print_description2": "Искате ли да продължите?",
  "leaflet_print_button": "Продължете",
  "leaflet_print_button_back": "Назад",
